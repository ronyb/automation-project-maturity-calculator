export interface Question {
  ...
  export const questions: Question[] = [
    ...
    { 
      question: "האם הרמה המקצועית/טכנית של מפתחי האוטומציה הקיימים בצוות גבוהה מספיק? (לדוגמה: מבינים את כל הטכנולוגיות שנעשה בהן שימוש בארגון כדוגמת כלי",
      answers: [
          "אנחנו מרוצים מהרמה המקצועית של מפתחי האוטומציה שלנו. יש להם יידע רחב בטכניקות וטכנולוגיות של אוטומציה וכלים משיקים",
